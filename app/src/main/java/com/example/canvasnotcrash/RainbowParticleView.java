...
public class RainbowParticleView extends View {
    //    private static int[] colors = {Color.RED, Color.YELLOW, Color.GREEN, Color.BLUE, Color.BLACK, Color.MAGENTA};
//    private static int[] colors = {Color.rgb(20, 20, 20), Color.RED};
//    private static int[] colors = {Color.RED, Color.WHITE};
//    private static int[] colors = {Color.parseColor("#2D2926"), Color.parseColor("#E94B3C")};
//    private static int[] colors = {Color.parseColor("#FFE77A"), Color.parseColor("#2C5F2D")};
//    private static int[] colors = {Color.parseColor("#FCF951"), Color.parseColor("#422057")};
//    private static int[] colors = {Color.parseColor("#00B1D2"), Color.parseColor("#FDDB27")}; // FAVORITE FOR DILIN
